...
cur.execute("SELECT order_id FROM ActiveOrders where counter < 220000;")    #removed limit 6-20 9:46pm
...
#for i in range(0,2):   
    ...
    sql1 ="""SELECT price, volume_remain, volume_total, location_id, order_id, date_pulled, type_id FROM EveSales0223 where order_id = %s limit %s"""
...
filenamesales = "MonthlySales"+todaydate+".csv"
