...
##########################  ENSURE THE COUNTER IS GREATER THAN THE NUMBER OF ACTIVE ORDERS ######################
...
cur.execute("SELECT order_id FROM ActiveOrders where counter < 100000;")    #removed limit 6-20 9:46pm
                                                                            #changed counter to 47 to tease out why an issue with '6027617026'
...
#for i in range(0,2):   
    ...
    ############################   CHANGE THIS TO THE CURRENT MONTH TO PROCESS I.E. EVESALES0921   #########################
    sql1 ="""SELECT price, volume_remain, volume_total, location_id, order_id, date_pulled, type_id FROM evebuysales0223 where order_id = %s limit %s"""
...
filenamesales = "MonthlyBUYS"+todaydate+".csv"
