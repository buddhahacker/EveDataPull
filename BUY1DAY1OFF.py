...
#for i in range(0,2):   
    ...
    sql1 ="""SELECT price, volume_remain, volume_total, location_id, order_id, date_pulled, type_id FROM eveBUY1DAY1OFF where order_id = %s limit %s"""
...
filenamesales = "1DAY1OFF"+todaydate+".csv"
