...
while i in range(2,len(typeid)):
    ...
    i+=1
    try:
        Sales = get_sell_orders(10000002,T_ID) # The Forge = 10000002 Everyshore 10000037, Metropolis 10000042
    except:
        print('url data pull error at id:', i)
    #print (Sales)
    print('index:',i)

    filename = "TheForge_Focused_BUY"+todaydate+".csv"
